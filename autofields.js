...
angular.module('autofields.core', [])
	.provider('$autofields', function(){
		...
		var getFieldContainer = function(directive, field, attrs){
			...
			attrs = angular.extend({}, (directive.options.attributes.container || autofields.settings.attributes.container), attrs);
		...
		var getLabel = function(directive, field, attrs){
			...
			attrs = angular.extend({}, (directive.options.attributes.label || autofields.settings.attributes.label), attrs);
		...
		var getInput = function(directive, field, html, attrs){
			...
			attrs = angular.extend({}, (directive.options.attributes.input || autofields.settings.attributes.input), attrs, field.attr);
